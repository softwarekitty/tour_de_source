...
Among the most common are capturing parts of a string and locating content within a file, with both occurring somewhere between occasionally and frequently. \todo{summary message}

\todo{add information about regexes and tests here}

\todo{add motivating paragraph for studying regexes, based on evidence provided here}
