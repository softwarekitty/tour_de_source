...
\subsubsection{\centerline{All Features}}
...
First Cosine similarity below:

\input{../analysis_output/cosClusters}

Jaccard similarity (by char set) below:

\input{../analysis_output/jaccClusters}

Jaro-Winkler similarity below:

\input{../analysis_output/jaroWClusters}

Levenshtein similarity below:

\input{../analysis_output/levClusters}

Longest Common substring similarity below:

\input{../analysis_output/lcsClusters}

Sift3 similarity below:

\input{../analysis_output/siftClusters}
