...
%This research has explored how regular expressions are used in practice.
...
\todoMid{move the discussion about simulating features out of this before removing it}
...
\todoLast{can this become more readable please? I'm lost in acronyms}
...
\todoMid{mention survey results here}
\leavevmode\color{gray}
...
\end{figure}
\leavevmode\color{black}
\todoMid{insert new sections about conclusions from survey}
...
\todoMid{fill in this and other ideas about future work}
