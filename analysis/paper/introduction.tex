...
Third, using  a semantic analysis to cluster similar regular expressions, we explore the most common behaviors captured by  regexes in Python. 
Our results indicate that regexes are frequently used in a variety of language and environments, that about half of the scraped Python projects use regexes, and that \todoLast{add short finding from clustering}. 
