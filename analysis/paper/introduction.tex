...
Our results indicate that regexes are most frequently used in command line tools and IDEs.  We observe that the capture group and endpoint anchor features are widely used by developers, but poorly supported in regex tools.  Capturing the contents of brackets and searching for delimiter characters were some of the most apparent  behavioral themes observed in the regex clusters created by our technique, and we also recognized a common cluster of regexes intended to parse source code.
