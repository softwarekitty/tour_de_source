...
First, we survey developers about the context of their regex usage, including how often and for what purposes regexes are composed.
Second, we measure how often regex features (e.g., kleene star, character classes, and capture groups) appear in regular expressions used in Python projects.
