...
When building and using regexes, it can be said, ``now you have two problems."
%\footnote{\url{http://regex.info/blog/2006-09-15/247}}
A skilled programmer can quickly solve many problems using regular expressions, but these regular expressions can be hard to understand, debug, and maintain, resulting in tens of thousands of bug reports~\cite{Spishak:2012:TSR:2318202.2318207}.
%per year???
Regular expression languages enable a valuable search technique used frequently within text editors, command line tools, and system tools.
Regular expressions are also employed in critical security applications, such as mysql injection prevention, malicious packet filtering  and web form validation. 
