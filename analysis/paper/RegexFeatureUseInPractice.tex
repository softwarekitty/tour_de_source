...
\newcommand{\todo}[1]{\textbf{\textcolor{red}{TODO: #1}}} %comment out for submission
%\newcommand{\todo}[1]{}
...
\todo{organize by internal, external, conclusion, construct}
...
\todo{add: mining regexes from repos represents just a fraction of all regexes composed by developers. A deeper study into programmer behavior regarding regex usage in all tools, not just those that appear in repos, is needed, and left for future work}
