...
\subsection{Clustering and Behavior Similarity Analysis}
Our similarity analysis clusters regular expressions by their behavioral similarity.
...
The end result is clusters of highly behaviorally similar regular expressions.  The top 100 clusters are categorized by inspection into six categories of behavior (see Section~\ref{rq4:results}).
