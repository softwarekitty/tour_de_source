...
\todoMid{explain how Rex generated strings. How likely is Rex to enumerate the same regular expressions for similar
regular expressions?}
...
\todoNow{fix this before the ICSE deadline - fix may be broken.}
