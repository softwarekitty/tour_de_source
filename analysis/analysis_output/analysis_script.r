...
par(mar=c(1,4,1,1), cex=0.97)
M_patternFiltering = matrix(c(78,354,13379),ncol=1,byrow=T)
rownames(M_patternFiltering)=c("alien feature 78 (0.6%)","pcre error 354 (2.6%)","included patterns 13,379 (96.9%)")
barplot(M_patternFiltering,legend=rownames(M_patternFiltering),col=c("mediumblue","lightskyblue1","seagreen2"),xlim=c(0,9),width=0.6,ylim = range(pretty(c(0, 13811))),las=1)
dev.off()
