...
par(mar=c(1,4,1,1), cex=0.97)
M_patternFiltering = matrix(c(258,9490,4365),ncol=1,byrow=T)
rownames(M_patternFiltering)=c("alien feature 258 (1.8%)","pcre error 9,490 (67.2%)","included patterns 4,365 (30.9%)")
