...
par(mar=c(1,4,1,1), cex=0.97)
M_patternFiltering = matrix(c(25,97,13597),ncol=1,byrow=T)
rownames(M_patternFiltering)=c("alien feature 25 (0.2%)","pcre error 97 (0.7%)","included patterns 13,597 (99.1%)")
barplot(M_patternFiltering,legend=rownames(M_patternFiltering),col=c("mediumblue","lightskyblue1","seagreen2"),xlim=c(0,9),width=0.6,ylim = range(pretty(c(0, 13719))),las=1)
dev.off()
