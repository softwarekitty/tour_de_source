...
\midrule
6 & OR & 759 & \begin{minipage}{3.5in}\begin{verbatim}`((the|a|an)\\s+)?[0-9]+'(193), `([ ]+_)|(_[ ]+)|([ ]+)'(66), `<.*>|</.*>'(63)\end{verbatim}\end{minipage}\\
\midrule
7 & DEC,NDEC & 622 & \begin{minipage}{3.5in}\begin{verbatim}`\d'(193), `(\D)[.]'(61), `\.\d+$'(14), `[^\w\d_]'(208)\end{verbatim}\end{minipage}\\
\midrule
8 & WRD,NWRD & 595 & \begin{minipage}{3.5in}\begin{verbatim}`\W'(208), \end{verbatim}\end{minipage}\\
\midrule
