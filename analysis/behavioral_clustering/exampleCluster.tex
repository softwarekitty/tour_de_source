...
\midrule
1 & \begin{minipage}{0.3in}\begin{verbatim}`\s*,\s*'\end{verbatim}\end{minipage} & 54  & 7 & \begin{minipage}{0.5in}\begin{verbatim}`,.*$'\end{verbatim}\end{minipage} & 3 \\
\midrule
2 & \begin{minipage}{0.3in}\begin{verbatim}`,'\end{verbatim}\end{minipage} & 30 & 8 & \begin{minipage}{0.6in}\begin{verbatim}`(\S+)\s*,\s*'\end{verbatim}\end{minipage} & 2 \\
\midrule
3 & \begin{minipage}{0.3in}\begin{verbatim}`\s*,'\end{verbatim}\end{minipage} & 16 & 9 & \begin{minipage}{0.5in}\begin{verbatim}`,+'\end{verbatim}\end{minipage} & 1 \\
\midrule
4 & \begin{minipage}{0.3in}\begin{verbatim}` ,\s*'\end{verbatim}\end{minipage} & 13 & 10 & \begin{minipage}{0.5in}\begin{verbatim}`,\ ?'\end{verbatim}\end{minipage} & 1 \\
\midrule
5 & \begin{minipage}{0.3in}\begin{verbatim}` *, *'\end{verbatim}\end{minipage} & 12 & 11 & \begin{minipage}{0.5in}\begin{verbatim}`\s*(,)\s*'\end{verbatim}\end{minipage} & 1 \\
\midrule
6 & \begin{minipage}{0.3in}\begin{verbatim}`,\S'\end{verbatim}\end{minipage} & 5 & 12 & \begin{minipage}{0.5in}\begin{verbatim}`\s*\,\s*'\end{verbatim}\end{minipage} & 1\\
