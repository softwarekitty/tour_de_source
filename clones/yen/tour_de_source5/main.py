...
s = [GithubPythonSourcer("20Commits", e1, p1, l, "investigation" + smallWords[4] + ":kos8izjrv3oary", 7340032, 7602175)]
t = Tourist(d, e1, p1, to, PythonRegexScanner(l), s, l, "Tour of " + smallWords[4] + " ended with status: ")
