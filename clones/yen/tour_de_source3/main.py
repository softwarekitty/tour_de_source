...
p1 = "cro0thiezlutrl"
smallWords = ["yak", "yam", "yaw", "yen", "yew", "yip", "yow", "yuk"]
...
s = [GithubPythonSourcer("20Commits", e1, p1, l, "investigation" + smallWords[2] + ":kos8izjrv3oary", 6815744, 7077887)]
t = Tourist(d, e1, p1, to, PythonRegexScanner(l), s, l, "Tour of " + smallWords[2] + " ended with status: ")
