...
s = [GithubPythonSourcer("20Commits", e1, p1, l, "investigation" + smallWords[5] + ":kos8izjrv3oary", 7602176, 7864319)]
t = Tourist(d, e1, p1, to, PythonRegexScanner(l), s, l, "Tour of " + smallWords[5] + " ended with status: ")
